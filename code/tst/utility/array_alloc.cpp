...
TEST_CASE( "static_storage<5, int>", "[utility]" )
{
	...
	aa1.section(mpl::index_constant<0>{}).construct_at(0, 5);
	aa1.section(mpl::index_constant<0>{}).construct_at(1, 4);
	aa1.section(mpl::index_constant<0>{}).construct_at(2, 3);
	aa1.section(mpl::index_constant<0>{}).construct_at(3, 2);
	aa1.section(mpl::index_constant<0>{}).construct_at(4, 1);

	static_assert(std::is_trivially_copy_constructible<static_storage>::value, "");
	static_storage aa2 = aa1;
	CHECK(aa2.section(mpl::index_constant<0>{}).data()[0] == 5);
	CHECK(aa2.section(mpl::index_constant<0>{}).data()[1] == 4);
	CHECK(aa2.section(mpl::index_constant<0>{}).data()[2] == 3);
	CHECK(aa2.section(mpl::index_constant<0>{}).data()[3] == 2);
	CHECK(aa2.section(mpl::index_constant<0>{}).data()[4] == 1);

	aa2.section(mpl::index_constant<0>{}).data()[2] = 6;

	// aa1.section(mpl::index_constant<0>{}).destruct_range(0, 5); // trivially destructible
	// aa1.deallocate(5); // trivial deallocate
	static_assert(std::is_trivially_copy_assignable<static_storage>::value, "");
	aa1 = aa2;
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[0] == 5);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[1] == 4);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[2] == 6);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[3] == 2);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[4] == 1);

	static_assert(std::is_trivially_move_constructible<static_storage>::value, "");
	static_storage aa3 = std::move(aa1);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[0] == 5);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[1] == 4);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[2] == 6);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[3] == 2);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[4] == 1);

	aa3.section(mpl::index_constant<0>{}).data()[2] = 9;

	// aa1.section(mpl::index_constant<0>{}).destruct_range(0, 5); // moved from, nothing to destruct
	// aa1.deallocate(5); // moved from, nothing to deallocate
	static_assert(std::is_trivially_move_assignable<static_storage>::value, "");
	aa1 = std::move(aa3);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[0] == 5);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[1] == 4);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[2] == 9);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[3] == 2);
	CHECK(aa1.section(mpl::index_constant<0>{}).data()[4] == 1);

	// aa3.section(mpl::index_constant<0>{}).destruct_range(0, 5); // moved from, nothing to destruct
	// aa2.section(mpl::index_constant<0>{}).destruct_range(0, 5); // trivial to destruct
	// aa1.section(mpl::index_constant<0>{}).destruct_range(0, 5); // trivial to destruct
...
TEST_CASE( "static_storage<5, unique_ptr>", "[utility]" )
{
	...
	aa1.section(mpl::index_constant<0>{}).construct_at(0, new int(5));
	aa1.section(mpl::index_constant<0>{}).construct_at(1, new int(4));
	aa1.section(mpl::index_constant<0>{}).construct_at(2, new int(3));
	aa1.section(mpl::index_constant<0>{}).construct_at(3, new int(2));
	aa1.section(mpl::index_constant<0>{}).construct_at(4, new int(1));
	...
	aa1.section(mpl::index_constant<0>{}).destruct_range(0, 5);
	// aa1.deallocate(5); // static array has trivial deallocate
}
...
TEST_CASE( "heap_storage<int>", "[utility]" )
{
	...
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[0] == 5);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[1] == 4);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[2] == 3);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[3] == 2);
	CHECK(aa3.section(mpl::index_constant<0>{}).data()[4] == 1);
...
TEST_CASE( "heap_storage<unique_ptr>", "[utility]" )
{
	...
	CHECK(*aa1.section(mpl::index_constant<0>{}).data()[0] == 5);
	CHECK(*aa1.section(mpl::index_constant<0>{}).data()[1] == 4);
	CHECK(*aa1.section(mpl::index_constant<0>{}).data()[2] == 3);
	CHECK(*aa1.section(mpl::index_constant<0>{}).data()[3] == 2);
	CHECK(*aa1.section(mpl::index_constant<0>{}).data()[4] == 1);
