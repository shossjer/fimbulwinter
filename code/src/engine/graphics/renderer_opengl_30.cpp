...
namespace
{
	...
	struct add_selectable_color
	{
		...
		void operator () (engine::MutableEntity entity, MeshObject & x)
		{
			debug_verify(selectable_components.emplace<selectable_mesh_object>(entity.entity(), x.mesh, x.object, color));
		}
