...
namespace engine
{
	namespace hid
	{
		...
		extern void notify_add_source(ui & ui, int id, std::string && path, int type, utility::string_view_utf8 name);
...
namespace engine
{
	namespace hid
	{
		...
		void add_source(int id, const char * path, int type, utility::string_view_utf8 name)
		{
